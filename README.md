...
All code samples, scripts and more in-depth examples for the book [Getting started with Generative AI](https://leanpub.com/quickstartwithai) AI Development with Local LLM
